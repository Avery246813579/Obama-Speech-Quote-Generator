...
class HashTableTest(unittest.TestCase):
    ...
    def test_keys(self):
        ...
        assert ht.keys() == ['I']
        ht.set('V', 5)
        self.assertEqual(ht.keys(), ['I', 'V'])  # Ignore item order
        ht.set('X', 10)
        self.assertEqual(ht.keys(), ['I', 'V', 'X'])  # Ignore item order
    ...
    def test_values(self):
        ...
        assert ht.values() == [1]
        ht.set('V', 5)
        self.assertEqual(ht.values(), [1, 5])  # Ignore item order
        ht.set('X', 10)
        self.assertEqual(ht.values(), [1, 5, 10])  # Ignore item order
    ...
    def test_items(self):
        ...
        assert ht.items() == [('I', 1)]
        ht.set('V', 5)
        self.assertEqual(ht.items(), [('I', 1), ('V', 5)])
        ht.set('X', 10)
        self.assertEqual(ht.items(), [('I', 1), ('V', 5), ('X', 10)])
